...
- Implementation screenshot: `artifacts/gospeak-home-polished.png`.
- Full-view comparison: `artifacts/general-design-qa-comparison.png`.
- Viewport: `1154x770`.
- State: General page, ASR Not Set, Rewrite Not Set, Active Profile Normal; hover checks for missing and ready cards.
